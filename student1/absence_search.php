...
<section style=" padding-left:300px; padding-top: 5%" >
         <form action="trait_absence_search.php" method="POST" id="form-search">
		...
		<div class="col-3">
            Date: <input type="date" name="date_search" id="date_search" class="form-control">
				...
				<div id="tableau"></div>
				<a href="list_absences.php" style="text-align:center;">------Voir la liste de presence des etudiants</a>
</section>
